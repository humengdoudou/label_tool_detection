...
# This is the python code for generating the .xml format file from the labelled .txt file to match the pascal voc format
#
# the generating procedure is not complicated, just read .txt file and generate the .xml format file,
# and we use the default values to fill the .xml file
#
...
labels      = 'Labels/20180123'                     # .txt files path
imgpath     = 'JPEGImages/20180123/'                # image path
xmlpath_new = 'Annotations/20180123/'               # generated .xml files path
foldername  = 'clothesRecognition'                  # folder tag, make it the same as training dataset folder name
